var stageData = '{ "stages" : [' +
  ...
  '{ "location":"Marrakesh", "name":"A House Built on Sand", "targets":["Kong Tuo-Kwang", "Matthieu Mendola"], "weapons":["gun", "bare hands", "drowning", "battle axe", "brick", "cleaver", "crowbar", "any knife", "lead pipe", "scissors", "screwdriver", "soda can", "wrench", "explosion"], "disguises":["Summer Suit", "Bodyguard", "Food Vendor", "Fortune Teller", "Handyman", "Military Soldier", "Shopkeeper", "Waiter"], "localWildcards":[]}, ' +
  '{ "location":"Bangkok", "name":"Club 27", "targets":["Jordan Cross", "Ken Morgan"], "weapons":["gun", "baseball bat", "cleaver", "coconut", "crowbar", "fire axe", "hammer", "golf club", "katana", "any knife", "letter opener", "screwdriver", "soda can", "wrench", "explosion", "environment", "poison", "drowning"], "disguises":["Casual Suit", "Abel de Silva", "Exterminator", "Groundskeeper", "Hotel Security", "Hotel Staff", "Jordan Cross Bodyguard", "Kitchen Staff", "Morgans Bodyguard", "Recording Crew", "Stalker", "Waiter"], "localWildcards":[]}, ' +
  ...
  '{ "location":"Hokkaido", "name":"Situs Inversus", "targets":["Erich Soders", "Yuki Yamazaki"], "weapons":["gun", "bare hands", "drowning", "lead pipe", "scissors", "bust", "soda can", "any knife", "wrench", "hammer", "fire axe", "screwdriver", "shovel", "crowbar", "scalpel", "fire poker", "cleaver", "explosion", "environment", "poison"], "disguises":["VIP Patient", "Baseball Player", "Bodyguard", "Chef", "Chief Surgeon", "Doctor", "Handyman", "Helicopter Pilot", "Hospital Director", "Morgue Doctor", "Motorcyclist", "Patient", "Ninja", "Resort Security", "Resort Staff", "Surgeon", "Yoga Instructor"], "localWildcards":["Take out the Hospital Director"]}, ' +
  '{ "location":"Hawke\'s Bay", "name":"Nightcall", "targets":["TBD"], "weapons":["gun", "bare hands", "drowning", "explosion", "environment", "poison", "TBD"], "disguises":["Suit", "TBD"], "localWildcards":[]}, ' +
  '{ "location":"Miami", "name":"The Finish Line", "targets":["TBD"], "weapons":["gun", "bare hands", "drowning", "explosion", "environment", "poison", "TBD"], "disguises":["Suit", "TBD"], "localWildcards":[]}, ' +
  '{ "location":"Santa Fortuna", "name":"Three-Headed Serpent", "targets":["TBD"], "weapons":["gun", "bare hands", "drowning", "explosion", "environment", "poison", "TBD"], "disguises":["Suit", "TBD"], "localWildcards":[]}, ' +
