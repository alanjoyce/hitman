var stageData = '{ "stages" : [' +
  ...
  '{ "location":"Santa Fortuna", "name":"Three-Headed Serpent", "targets":["Rico Delgado", "Andrea Martinez", "Jorge Franco"], "weapons":["gun", "bare hands", "drowning", "explosion", "environment", "poison", "barber razor", "baseball", "baseball bat", "brick", "any axe", "bust", "car battery", "cleaver", "fish", "any knife", "frying pan", "hammer", "lead pipe", "letter opener", "machete", "scissors", "screwdriver", "shovel", "soda can", "wrench"], "disguises":["Suit", "Barman", "Chef", "Coca Field Guard", "Coca Field Worker", "Construction Worker", "Drug Lab Worker", "Drummer", "Elite Guard", "Gardener", "Hippie", "Hippo Whisperer", "Mansion Guard", "Mansion Staff", "Shaman", "Street Soldier", "Submarine Crew", "Submarine Engineer", "Tattooist"], "localWildcards":[]}, ' +
  '{ "location":"Mumbai", "name":"Chasing a Ghost", "targets":["Wazir Kale", "Vanya Shah", "Dawood Rangan"], "weapons":["gun", "bare hands", "drowning", "explosion", "environment", "poison", "any knife", "barber razor", "baseball bat", "brick", "car battery", "cricket ball", "cleaver", "crowbar", "any axe", "fish", "frying pan", "hammer", "lead pipe", "letter opener", "rake", "saber", "scissors", "screwdriver", "shovel", "soda can", "wrench"], "disguises":["Suit", "Barber", "Bollywood Bodyguard", "Bollywood Crew", "Dancer", "Elite Thug", "Food Vendor", "Holy Man", "Kashmirian", "Laundry Foreman", "Laundry Worker", "Lead Actor", "Local Security", "Metal Worker", "Painter", "Queen\'s Bodyguard", "Queen\'s Guard", "Tailor", "Thug", "Vanya\'s Servant"], "localWildcards":[]}, ' +
  '{ "location":"Whittleton Creek", "name":"Another Life", "targets":["Janus", "Nolan Cassidy"], "weapons":["gun", "bare hands", "drowning", "explosion", "environment", "poison", "baseball", "baseball bat", "any axe", "blueberry muffin", "brick", "bust", "car battery", "crowbar", "golf club", "hammer", "hatchet", "any knife", "lead pipe", "letter opener", "paddle", "rake", "scissors", "screwdriver", "shovel", "soda can", "wrench"], "disguises":["Suit", "Arkian Robe", "BBQ Owner", "Cassidy Bodyguard", "Construction Worker", "Exterminator", "Garbage Man", "Gardener", "Gunther Mueller", "James Batty", "Janus\' Bodyguard", "Mailman", "Nurse", "Plumber", "Police Deputy", "Politician", "Politician\'s Assistant", "Real Estate Broker", "Server", "Sheriff Masterson", "Spencer \"The Hammer\" Green"], "localWildcards":[]}, ' +
